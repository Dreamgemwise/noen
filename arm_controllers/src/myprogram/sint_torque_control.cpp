...
namespace arm_controllers
{
    ...
    class sintTorqueController : public controller_interface::Controller<hardware_interface::EffortJointInterface>
    {
        class GainsHandler
        {
        public:
    ...
    public:
        ...
        bool init(hardware_interface::EffortJointInterface *hw, ros::NodeHandle &n)
        {
            ...
            command_sub_ = n.subscribe<std_msgs::Float64MultiArray>("command", 1, &sintTorqueController::commandCB, this);
...
PLUGINLIB_EXPORT_CLASS(arm_controllers::sintTorqueController, controller_interface::ControllerBase)