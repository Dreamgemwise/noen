...
namespace arm_controllers
{
  ...
  public:
    ...
    void update(const ros::Time& time, const ros::Duration& period)
    {
      ...
      {
        std::cout << std::setw(10) << lambda1_(0) << ", "
  ...
  private:
    ...
    std::vector<double> lambda1_vector, lambda2_vector, lambda3_vector, fc_vector, fv_vector, fs_vector, kf_vector, wf_vector, km_vector, w1_vector, gamma1_vector, miu_vector, eta_vector, k1_vector;
