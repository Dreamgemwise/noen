...
namespace arm_controllers
{
  ...
  public:
    ...
    bool init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle& n)
    {
      ...
      if (!n.getParam("b_", b_vector)) {
          ROS_ERROR("Could not find b_ parameter");
          return false;
      }
      if (b_vector.size() != 7) {
          ROS_ERROR("b_ parameter should have 2 elements");
          return false;
      }
      b_ << b_vector[0], b_vector[1],b_vector[2], b_vector[3],b_vector[4], b_vector[5],b_vector[6];
      ...
      data_file_ << "Time,e_0,e`_1,q_0,q_4,dq_0,dq_4,dqr_0,dqr_1,dqd_0,dqd_1,ddqd_0,ddqd_1,tau_0,tau_4,Fext_0,Fext_1,N_hat_1,N_hat_2" << std::endl;
    ...
    void update(const ros::Time& time, const ros::Duration& period)
    {
      ...
      for (size_t i = 0; i < 7; i++) {
          ...
          std::cout<< col1_<<","<<col2_<<","<<norm_val1<<","<<norm_val2<<","<<exponent1<<","<<exponent2<<","<<h1_(i)<<","<<h2_(i);
      }
      std::cout << "," << std::endl;
      ...
      {
        std::cout
          << std::setw(10) << w_hat1_(0) << ", "
          << std::setw(10) << w_hat1_(1) << ", "
          << std::setw(10) << w_hat1_(2) << ", "
          << std::setw(10) << w_hat1_(3) << ", "
          << std::setw(10) << w_hat1_(4) << ", "
          << std::setw(10) << w_hat1_(5) << ", "
          << std::setw(10) << w_hat1_(6) << ", " << " | "
          << std::setw(10) << w_hat2_(0) << ", "
          << std::setw(10) << w_hat2_(1) << ", "
          << std::setw(10) << w_hat2_(2) << ", "
          << std::setw(10) << w_hat2_(3) << ", "
          << std::setw(10) << w_hat2_(4) << ", "
          << std::setw(10) << w_hat2_(5) << ", "
          << std::setw(10) << w_hat2_(6) << ", " << " || "
          << std::setw(10) << h1_(0) << ", "
          << std::setw(10) << h1_(1) << ", "
          << std::setw(10) << h1_(2) << ", "
          << std::setw(10) << h1_(3) << ", "
      ...
      if (t <= 20.0)
      {
        ...
        data_file_
          ...
          << N_hat_(1) << std::endl;
        data_file_.flush();
        // "Time,e_0,e`_1,q_0,q_4,dq_0,dq_4,dqr_0,dqr_1,dqd_0,dqd_1,ddqd_0,ddqd_1,tau_0,tau_4,Fext_0,Fext_1,N_hat_1,N_hat_2"
      }
      else
      {
        if (data_file_.is_open())
  ...
  private:
    ...
    std::vector<double> l_vector, c1_vector, c2_vector,b_vector;
