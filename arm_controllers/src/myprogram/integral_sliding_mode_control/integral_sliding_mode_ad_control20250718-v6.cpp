...
namespace arm_controllers
{
  ...
  public:
    ...
    void update(const ros::Time& time, const ros::Duration& period)
    {
      ...
      tau_[0] = C_(0, 0) * dq_[0] + C_(0, 1) * dq_[4] + M_(0, 0) * (ddqd_(0) + k1_(0) * Phi1_(0) - g_(0) + ki_(0) * e_(0)) + M_(0, 1) * (ddqd_(1) + k1_(1) * Phi1_(1) - g_(1) + ki_(1) * e_(0));
      tau_[4] = C_(1, 0) * dq_[0] + C_(1, 1) * dq_[4] + M_(1, 0) * (ddqd_(0) + k1_(0) * Phi1_(0) - g_(0) + ki_(0) * e_(0)) + M_(1, 1) * (ddqd_(1) + k1_(1) * Phi1_(1) - g_(1) + ki_(1) * e_(0));
  ...
  private:
    ...
    std::vector<double> lambda1_vector, lambda2_vector, lambda3_vector, fc_vector, fv_vector, fs_vector, kf_vector, wf_vector, km_vector, w1_vector, gamma1_vector, miu_vector, eta_vector, k1_vector, Md_vector, Bd_vector, ki_vector;
