  ...
  public:
    ...
    bool init(hardware_interface::EffortJointInterface *hw, ros::NodeHandle &n)
    {
      ...
      beta0_ << 4.0,
          4.0;
      // 控制律限制
      min_val_ = {{-5.0, -20.0, -20.0, -3.0, -5.0, -3.0}}; // 下限
      max_val_ = {{5.0, 20.0, 20.0, 3.0, 5.0, 3.0}};       // 上限
      ...
      B = 0.20;
      delta = M_PI / 1800;
      ke_ = {{2000.0, 2000.0, 2000.0, 2000.0, 2000.0, 2000.0}};
      ...
      //   return false;
      // }
      output_file_path_ = "/home/triyi/catkin_ws/src/arm_controllers/src/myprogram/output_data.txt";
      ...
      // 写入文件头
      data_file_ << "Time, e_0, e_1, dqr_0,dqr_1,dqd_0,dqd_1,ddqd_0,ddqd_1,tau_0, tau_1, tau_2, tau_3, tau_4, tau_5, Fext_0, Fext_1" << std::endl;
