    ...
    class AdmittanceController : public controller_interface::Controller<hardware_interface::EffortJointInterface> {
      public:
        ...
        void update(const ros::Time& time, const ros::Duration& period) {
            ...
            // tau_[0] = C_(0, 0) * dq_[0] + C_(0, 1) * dq_[4] + G_(0) - M_(0, 0) * ((-1.0) * k1_(0) * Phi1_(0) + g_(0) + (lambda1_(0) + (19.0 / 7.0) * lambda2_(0) * pow(fabs(e_(0)), 12.0 / 7.0)) * ddqd_(0) - lambda3_(0) * pow(fabs(e_(0)), 1.0 / 3.0) * sign(e_(0))) / (lambda1_(0) + (19.0 / 7.0) * lambda2_(0) * pow(fabs(e_(0)), 12.0 / 7.0)) - M_(0, 1) * ((-1.0) * k1_(1) * Phi1_(1) + g_(1) + (lambda1_(1) + (19.0 / 7.0) * lambda2_(1) * pow(fabs(e_(1)), 12.0 / 7.0)) * ddqd_(1) - lambda3_(1) * pow(fabs(e_(1)), 1.0 / 3.0) * sign(e_(1))) / (lambda1_(0) + (19.0 / 7.0) * lambda2_(0) * pow(fabs(e_(0)), 12.0 / 7.0));
            // tau_[4] = C_(1, 0) * dq_[0] + C_(1, 1) * dq_[4] + G_(4) - M_(1, 0) * ((-1.0) * k1_(0) * Phi1_(0) + g_(0) + (lambda1_(0) + (19.0 / 7.0) * lambda2_(0) * pow(fabs(e_(0)), 12.0 / 7.0)) * ddqd_(0) - lambda3_(0) * pow(fabs(e_(0)), 1.0 / 3.0) * sign(e_(0))) / (lambda1_(1) + (19.0 / 7.0) * lambda2_(1) * pow(fabs(e_(1)), 12.0 / 7.0)) - M_(1, 1) * ((-1.0) * k1_(1) * Phi1_(1) + g_(1) + (lambda1_(1) + (19.0 / 7.0) * lambda2_(1) * pow(fabs(e_(1)), 12.0 / 7.0)) * ddqd_(1) - lambda3_(1) * pow(fabs(e_(1)), 1.0 / 3.0) * sign(e_(1))) / (lambda1_(1) + (19.0 / 7.0) * lambda2_(1) * pow(fabs(e_(1)), 12.0 / 7.0));

            // tau_[0] = C_(0, 0) * dq_[0] + C_(0, 1) * dq_[4] - M_(0, 0) * ((-1.0) * k1_(0) * Phi1_(0) + g_(0) + (lambda1_(0) + (19.0 / 7.0) * lambda2_(0) * pow(fabs(e_(0)), 12.0 / 7.0)) * ddqd_(0) - lambda3_(0) * pow(fabs(e_(0)), 1.0 / 3.0) * sign(e_(0))) / (lambda1_(0) + (19.0 / 7.0) * lambda2_(0) * pow(fabs(e_(0)), 12.0 / 7.0)) - M_(0, 1) * ((-1.0) * k1_(1) * Phi1_(1) + g_(1) + (lambda1_(1) + (19.0 / 7.0) * lambda2_(1) * pow(fabs(e_(1)), 12.0 / 7.0)) * ddqd_(1) - lambda3_(1) * pow(fabs(e_(1)), 1.0 / 3.0) * sign(e_(1))) / (lambda1_(0) + (19.0 / 7.0) * lambda2_(0) * pow(fabs(e_(0)), 12.0 / 7.0));
            // tau_[4] = C_(1, 0) * dq_[0] + C_(1, 1) * dq_[4] - M_(1, 0) * ((-1.0) * k1_(0) * Phi1_(0) + g_(0) + (lambda1_(0) + (19.0 / 7.0) * lambda2_(0) * pow(fabs(e_(0)), 12.0 / 7.0)) * ddqd_(0) - lambda3_(0) * pow(fabs(e_(0)), 1.0 / 3.0) * sign(e_(0))) / (lambda1_(1) + (19.0 / 7.0) * lambda2_(1) * pow(fabs(e_(1)), 12.0 / 7.0)) - M_(1, 1) * ((-1.0) * k1_(1) * Phi1_(1) + g_(1) + (lambda1_(1) + (19.0 / 7.0) * lambda2_(1) * pow(fabs(e_(1)), 12.0 / 7.0)) * ddqd_(1) - lambda3_(1) * pow(fabs(e_(1)), 1.0 / 3.0) * sign(e_(1))) / (lambda1_(1) + (19.0 / 7.0) * lambda2_(1) * pow(fabs(e_(1)), 12.0 / 7.0));
            ...
            // tau_[0] += fc_(0) * sign(dq_[0]) + fv_(0) * tanh(kf_(0) * dq_[0]) + fs_(0) * exp(-(dq_[0] / wf_(0)) * (dq_[0] / wf_(0))) * sign(dq_[0]);
            // tau_[4] += fc_(1) * sign(dq_[4]) + fv_(0) * tanh(kf_(1) * dq_[4]) + fs_(1) * exp(-(dq_[4] / wf_(1)) * (dq_[4] / wf_(1))) * sign(dq_[4]);
            ...
            if (count < 10) {
                ...
                std::cout
                    ...
                    << std::setw(10) << dqr_(0) << ", " << std::setw(10) << dqr_(1)
                    << ", "
                    //   << std::setw(10) << ddqr_(0) << ", "
                    //   << std::setw(10) << ddqr_(1) << ", "
                    ...
                    << std::setw(10) << dqd_(0) << ", " << std::setw(10) << dqd_(1)
                    << ", "
                    // << std::setw(10) << ddqd_(0) << ", "
                    // << std::setw(10) << ddqd_(1) << ", "
                    // << std::setw(10) << dq_[0] << ", "
                    ...
                    // << std::setw(10) << tau_[0] << ", "
                    // << std::setw(10) << tau_[4] << ", "
                    << std::setw(10) << Fext_(0) << ", " << std::setw(10) << Fext_(1) << std::endl;  // 换行
                count = 0;
            }
            ...
            if (t <= 20.0) {
                // 将数据写入文件
                data_file_ << t << ", " << e_(0) << ", " << e_(1) << ", " << s_(0) << ", " << s_(1) << ", " << k1_(0) << ", " << k1_(1) << ", " << q_[0] << ", " << q_[4] << ", " << dq_[0] << ", " << dq_[4] << ", " << dqr_(0) << ", " << dqr_(1) << ", " << dqd_(0) << ", " << dqd_(1) << ", " << ddqd_(0) << ", " << ddqd_(1) << ", " << tau_cmd_[0] << ", " << tau_cmd_[4] << ", " << Fext_(0) << ", " << Fext_(1) << std::endl;
                data_file_.flush();
      ...
      private:
        ...
        Eigen::Matrix<double, 2, 1> F_Joint_, Fext_, dqr_, ddqr_, dqr_last_, fc_, fv_, fs_, kf_, wf_;
