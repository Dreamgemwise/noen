...
plt.figure(figsize=(6, 3))
plt.plot(time, tau_0, label='tau_0')
plt.plot(time, tau_4, label='tau_1')
plt.xlabel('Time (s)')
plt.ylabel('tau')
plt.legend()
...
# N_hat_
N_hat_1 = data['N_hat_1']
N_hat_2 = data['N_hat_2']
plt.figure(figsize=(6, 6))
plt.plot(time, N_hat_1, label='N_hat_1')
plt.plot(time, N_hat_2, label='N_hat_2')
plt.xlabel('Time (s)')
plt.ylabel('N_hat_')
plt.legend()
...
plt.plot(time, dq_0, label='dq1')
plt.plot(time, dq_1, label='dq2')
plt.plot(time, dqd_0, label='dqd1')
plt.plot(time, dqd_1, label='dqd2')
plt.plot(time, ddqd1, label='ddqd1')
plt.plot(time, ddqd2, label='ddqd2')
plt.xlabel('Time (s)')
plt.ylabel('scope')
plt.legend()
