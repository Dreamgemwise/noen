...
namespace arm_controllers
{
  ...
  public:
    ...
    bool init(hardware_interface::EffortJointInterface *hw, ros::NodeHandle &n)
    {
      ...
      beta0_ << 4.0,
          4.0;
      // 控制律限制
      min_val_ = {{-8.0, -20.0, -20.0, -3.0, -8.0, -3.0}}; // 下限
      max_val_ = {{8.0, 20.0, 20.0, 3.0, 8.0, 3.0}};       // 上限
      ...
      B = 0.20;
      delta = M_PI / 1800;
      ke_ = {{2000.0, 3000.0, 2000.0, 2000.0, 2000.0, 2000.0}};
      ...
      // 写入文件头
      data_file_ << "Time,e_0,e_1,s_0,s_1,q_0,q_4,dqr_0,dqr_1,dqd_0,dqd_1,ddqd_0,ddqd_1,tau_0,tau_4,Fext_0,Fext_1" << std::endl;
    ...
    void update(const ros::Time &time, const ros::Duration &period)
    {
      ...
      std::cout << T << ", "
                ...
                << std::setw(10) << tau_[0] << ", "
                << std::setw(10) << tau_[4] << ", "
                // << std::setw(10) << tau_cmd_[0] << ", "
                // << std::setw(10) << tau_cmd_[1] << ", "
                // << std::setw(10) << tau_cmd_[2] << ", "
                // << std::setw(10) << tau_cmd_[3] << ", "
                // << std::setw(10) << tau_cmd_[4] << ", "
                // << std::setw(10) << tau_cmd_[5] << ", "
                // << std::setw(10) << tau1_[0] << ", "
                // << std::setw(10) << tau1_[1] << ", "
                // << std::setw(10) << tau1_[2] << ", "
                // << std::setw(10) << tau1_[3] << ", "
  ...
  private:
    ...
    double t, T, l1, l2, xc, yc, r0, k0, epsilon1, VD, c0, B, K, delta;
