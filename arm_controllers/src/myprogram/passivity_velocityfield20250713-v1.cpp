...
namespace arm_controllers
{
  ...
  public:
    ...
    bool init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle& n)
    {
      ...
      beta0_ << 4.0,
        4.0;
      // 控制律限制
      min_val_ = { {-10.0, -20.0, -20.0, -3.0, -10.0, -3.0} }; // 下限
      max_val_ = { {10.0, 20.0, 20.0, 3.0, 10.0, 3.0} };       // 上限
  ...
  private:
    ...
    std::vector<double> lambda1_vector, lambda2_vector, lambda3_vector;
    ...
    Eigen::Matrix<double, 2, 1> F_Joint_, Fext_, dqr_, ddqr_, dqr_last_;
